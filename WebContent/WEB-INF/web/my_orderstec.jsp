...
<script type="text/javascript">
    ...
    var initDataList1 = function() {
        ...
        var url = '${pageContext.request.contextPath}/selectWebMyOrdersDatatec';// 获取分页数据的连接
	                    ...
	                    success:function (data) {
	                    	if(data == 'nologin'){
	    	                 	...
	    	                 	layer.msg('请先登录',{
	    	                	  ...
	    	                	  window.location.href="${pageContext.request.contextPath}/toMyWebOrderstec";//相当于刷新界面   
	    	                  }); 
	                    	}else{
	                    		layer.msg('归还成功',{
	    	                        offset:['50%'],
