...
<div class="layui-header header">
    ...
    <ul class="layui-nav layui-layout-right layui-nav-right" lay-filter="filter">
      ...
      <li class="layui-nav-item">
        <a href="javascript:;"><img src="upload/${teacher.photo }" class="layui-nav-img">${teacher.name}</a>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <div class="layui-tab-content" style="padding: 20px 0;">
        <div class="layui-form layui-form-pane layui-tab-item layui-show">
          <form class="layui-form" method="post" action="<%=path%>/updateWebUserInfotec">
           <input type="hidden" id="id" name="id" value="${teacher.id}">
            <div class="layui-form-item">
              <label for="L_email" class="layui-form-label">电话</label>
              <div class="layui-input-inline">
                <input type="text" name="phone" lay-verify="required"  value="${teacher.phone }"autocomplete="off" class="layui-input">
              </div>
            </div>
            <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">姓名</label>
              <div class="layui-input-inline">
                <input type="text" name="name" lay-verify="required" autocomplete="off" value="${teacher.name }" class="layui-input">
              </div>
              </div>
              <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">年龄</label>
              <div class="layui-input-inline">
                <input type="text" name="age" lay-verify="required" autocomplete="off" value="${teacher.age }" class="layui-input">
              </div>
              </div>
              <div class="layui-form-item">
              <div class="layui-inline">
                <div class="layui-input-inline">
                  <input type="radio" name="sex" value="男" checked title="男" <c:if test="${teacher.sex eq '男'}">checked</c:if>>
                  <input type="radio" name="sex" value="女" title="女" <c:if test="${teacher.sex eq '女'}">checked</c:if>>
                </div>
              </div>
            </div>
           <div class="layui-form-item">
              <label for="L_city" class="layui-form-label">学历</label>
              <div class="layui-input-inline">
                <input type="text" id="education" name="education" lay-verify="required" autocomplete="off" value="${teacher.education }" class="layui-input">
              </div>
            </div> 
            <div class="layui-form-item">
              <label for="L_city" class="layui-form-label">所属学院</label>
              <div class="layui-input-inline">
                <input type="text" id="insitute" name="insitute" lay-verify="required" autocomplete="off" value="${teacher.insitute }" class="layui-input">
              </div>
            </div> 
            <div class="layui-form-item">
              <label for="L_city" class="layui-form-label">职位</label>
              <div class="layui-input-inline">
                <input type="text" id="job" name="job" lay-verify="required" autocomplete="off" value="${teacher.job }" class="layui-input">
              </div>
            </div> 
            <div class="layui-form-item">
          ...
          <div class="layui-form layui-form-pane layui-tab-item">
           <form class="layui-form" method="post" action="<%=path%>/updateWebUserTXtec"   >
	            <div class="layui-form-item">
	               <div class="layui-input-inline uploadHeadImage">
				        <div class="layui-upload-drag" id="headImg">
				          <img class="layui-upload-img headImage" src="upload/${teacher.photo}" id="demo1" style="width:100px;height:100%">
				            <p id="demoText"></p>
				            <p>点击上传图片</p>
				        </div>
				    </div>
				    <input type="hidden" id="photo" name="photo" value="${teacher.photo}">
				    <input type="hidden" id="id" name="id" value="${teacher.id}">
	            </div>
            	<div class="layui-form-item">
          ...
          <div class="layui-form layui-form-pane layui-tab-item">
            <form class="layui-form" method="post" action="<%=path%>/updateWebUserPwdtec">
             <input type="hidden" id="id" name="id" value="${teacher.id}">
